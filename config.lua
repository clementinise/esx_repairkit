...
Config.IfMechanicIsOnline			= true		-- Set to true if you don't want your players to use the RepairKit and TireKit if a mechanic is online
...
Config.AllowMechanic				= false	 	-- Allow mechanics to use this repairkit? (If you want this to work set "Config.IfMecaIsOnline" to false, it's a known bug that will be fixed as soon as possible)
